...
Overall, the Nova sofa bed without storage offers a practical solution for maximizing space in living rooms while providing versatile functionality. Its ability to seamlessly transition between sofa and bed configurations makes it a valuable addition to any home seeking to optimize space without compromising on comfort or style. With its modern design, durable construction, and multipurpose usage, the Nova sofa bed without storage ensures both practicality and aesthetic appeal in contemporary living environments.',
  ...
  'L: 1.9m, W: 0.9m, H: 0.85m',
  'sofa-bed, space-saving, living-room, fabric, multipurpose',
  ...
  'Nova Sofa Bed Without Storage - front view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/nova-sofa-bed-without-storage-2.jpg',
  'Nova Sofa Bed Without Storage - side view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/nova-sofa-bed-without-storage-3.jpg'
);

-- Product 2: Voyager NEC Chair
INSERT INTO products (
  name, slug, category, brand, description, price, discount_price, 
  stock, best_seller, material, dimensions, tags, 
  image_1_url, image_1_alt, image_2_url, image_2_alt, image_3_url
) VALUES (
  'Voyager NEC Chair',
  'voyager-nec-chair',
  'Lazy Chairs, space saving furniture',
  'SpaceCraft',
...
Overall, the Voyager NEC Chair combines functionality, comfort, and style in one compact, foldable design. Its space-saving features, coupled with its durable construction and sleek look, make it an ideal choice for anyone looking to enhance their seating options without compromising on style or space.',
  ...
  'L: 0.65m, W: 0.6m, H: 0.95m',
  'lazy-chair, folding-chair, space-saving, seating',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/voyager-nec-chair-1.jpg',
  'Voyager NEC Chair - front view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/voyager-nec-chair-2.jpg',
  'Voyager NEC Chair - side view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/voyager-nec-chair-3.jpg'
);
...
INSERT INTO products (
  ...
  'halley-sofa-cum-bed-single',
  'Sofa Cum Beds, space saving furniture',
  'SpaceCraft',
...
Overall, the Halley sofa cum bed single represents a smart choice for individuals or families seeking versatile living room furniture that maximizes space and functionality. Its ability to transform effortlessly between a sofa and a bed makes it a practical investment for optimizing living spaces without sacrificing comfort or style.',
  ...
  false,
  'Fabric Upholstery, Hardwood & Metal Frame',
  'L: 1.8m, W: 0.85m, H: 0.8m',
  'sofa-bed, single, space-saving, guest-room',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/halley-sofa-cum-bed-single-1.jpg',
  'Halley Sofa Cum Bed Single - front view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/halley-sofa-cum-bed-single-2.jpg',
  'Halley Sofa Cum Bed Single - converted to bed',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/halley-sofa-cum-bed-single-3.jpg'
);
...
In summary, the Proton Study Desk is an exemplary piece of space-saving furniture that meets the needs of modern students and professionals. With its blend of practicality, durability, and elegant design, it provides a functional and aesthetically pleasing workspace that enhances productivity and organization in any study or work environment.',
  ...
  'L: 1.2m, W: 0.6m, H: 0.75m',
  'study-table, desk, engineered-wood, home-office',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/proton-study-desk-1.jpg',
  'Proton Study Desk - front view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/proton-study-desk-2.jpg',
  'Proton Study Desk - side angle with storage',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/proton-study-desk-3.jpg'
);
...
Overall, the Jupiter Bunk Cum Futon Cot exemplifies the modern approach to living room furniture, where space efficiency and multipurpose functionality are paramount. Its ability to serve as both a bunk bed and a futon ensures practicality without compromising on comfort or style. For individuals or families looking to maximize space in their living areas while maintaining flexibility in furniture usage, the Jupiter Bunk Cum Futon Cot offers an attractive and practical solution.',
  ...
  'L: 2.0m, W: 1.0m, H: 1.7m',
  'bunk-bed, futon, space-saving, metal',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/jupiter-bunk-cum-futon-cot-1.jpg',
  'Jupiter Bunk Cum Futon Cot - full view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/jupiter-bunk-cum-futon-cot-2.jpg',
  'Jupiter Bunk Cum Futon Cot - futon detail',
  NULL
);
...
In conclusion, Luminous Steel Cot is a trusted name in the realm of bedroom furniture, celebrated for their metal king-sized beds, metal queen-sized beds, and steel cots with innovative storage solutions. Their dedication to craftsmanship, combined with thoughtful design and customizable options, ensures that every piece not only enhances the functionality of the bedroom but also elevates its aesthetic appeal. Whether you''re furnishing a master bedroom, guest room, or any other living space, Luminous Steel Cot offers timeless furniture solutions that embody quality, comfort, and style.',
  ...
  'L: 2.0m, W: 1.6m, H: 0.95m',
  'steel-cot, storage-bed, metal',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/luminous-steel-cot-1.jpg',
  'Luminous Steel Cot - front view',
  NULL,
  NULL,
  NULL
);
...
In conclusion, the Sputnic Convertable Wooden Leg Bunk Bed combines functionality with space-saving efficiency, making it an excellent choice for modern living spaces. Its durable construction, convertible design, and safety features ensure both comfort and practicality, accommodating various sleeping arrangements and room configurations with ease.',
  ...
  'L: 2.0m, W: 1.0m, H: 1.6m',
  'bunk-bed, convertible, wooden-leg, space-saving',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/sputnic-convertable-wooden-leg-bunk-bed-1.jpg',
  'Sputnic Convertable Wooden Leg Bunk Bed - assembled view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/sputnic-convertable-wooden-leg-bunk-bed-2.jpg',
  'Sputnic Convertable Wooden Leg Bunk Bed - separated configuration',
  NULL
);
...
In conclusion, the Rainbow Convertable Bunk Bed combines practicality with space-saving efficiency, making it an excellent choice for modern living spaces. Its versatile design, durable construction, and safety features ensure both comfort and functionality, catering to various sleeping arrangements and room configurations with ease.',
  ...
  'L: 2.0m, W: 1.0m, H: 1.6m',
  'bunk-bed, convertible, metal',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/rainbow-convertable-bunk-bed-1.jpg',
  'Rainbow Convertable Bunk Bed - bunk configuration',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/rainbow-convertable-bunk-bed-2.jpg',
  'Rainbow Convertable Bunk Bed - single configuration',
  NULL
);
...
Overall, the Zenith Rocking Easy Chair is a prime example of multipurpose furniture that excels in both form and function. Its space-saving, foldable design combined with its relaxing, easy chair attributes makes it an excellent choice for those seeking a practical and stylish seating solution.',
  ...
  'L: 0.75m, W: 0.7m, H: 1.0m',
  'rocking-chair, easy-chair, seating, space-saving',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/zenith-rocking-easy-chair-1.jpg',
  'Zenith Rocking Easy Chair - front view',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/zenith-rocking-easy-chair-2.jpg',
  'Zenith Rocking Easy Chair - side angle',
  'https://oduvaeykaeabnpmyliut.supabase.co/storage/v1/object/public/spacecraftsdigital/products/zenith-rocking-easy-chair-3.jpg'
);

-- Verification Query: Check if products were inserted successfully
-- Run this after the inserts to verify
SELECT name, slug, category, price, discount_price, best_seller, stock
FROM products
WHERE brand = 'SpaceCraft'
